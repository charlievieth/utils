...
func TestBasics(t *testing.T) {
	var s fastwalk.LockingSparseSet
	if len := s.Len(); len != 0 {
...
func TestMoreBasics(t *testing.T) {
	set := new(fastwalk.LockingSparseSet)
	set.Insert(456)
	set.Insert(123)
	set.Insert(789)
	if set.Len() != 3 {
...
func TestTakeMin(t *testing.T) {
	var set fastwalk.LockingSparseSet
	set.Insert(456)
	set.Insert(123)
	set.Insert(789)
	set.Insert(-123)
...
func TestEquals(t *testing.T) {
	var setX fastwalk.LockingSparseSet
	setX.Insert(456)
	setX.Insert(123)
	setX.Insert(789)
	...
	var setY fastwalk.LockingSparseSet
	setY.Insert(789)
	setY.Insert(456)
	setY.Insert(123)
	...
	var empty fastwalk.LockingSparseSet
...
// A pset is a parallel implementation of a set using both an fastwalk.LockingSparseSet
// and a built-in hash map.
type pset struct {
	hash map[int]bool
	bits fastwalk.LockingSparseSet
}
...
func TestIntersectionWith(t *testing.T) {
	...
	var X, Y fastwalk.LockingSparseSet
	X.Insert(1)
	X.Insert(1000)
	X.Insert(8000)
	Y.Insert(1)
...
func TestIntersects(t *testing.T) {
	...
	for i := uint(0); i < 12; i++ {
		...
		// test the slow way
		var z fastwalk.LockingSparseSet
		z.Copy(x)
...
func TestFailFastOnShallowCopy(t *testing.T) {
	var x fastwalk.LockingSparseSet
	x.Insert(1)
...
func BenchmarkUnionDifferenceSparse(b *testing.B) {
	prng := rand.New(rand.NewSource(0))
	for tries := 0; tries < b.N; tries++ {
		var x, y, z fastwalk.LockingSparseSet
		for i := 0; i < 1000; i++ {
